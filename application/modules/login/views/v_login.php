			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						...
						<!--end::Logo-->
						<!--begin::Title-->
						<div class="text-white fw-normal m-0" style="font-size: 30px;
    text-align: center;
    width: 100%;">
							STAR PINS
						</div>
						...
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="" action="<?php echo $action; ?>" method="POST">
								...
								<div class="fv-row mb-3">
									<!--begin::Password-->
									<input id="password" type="password" placeholder="Masukan Password Terdaftar" name="password" autocomplete="off" class="form-control form-control-sm bg-transparent" required />
								...
								<!--end::Input group=-->
								<!--begin::Wrapper-->
								<div style="display:none !important" class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
									<div></div>
									<!--begin::Link-->
								...
								<div class="d-grid mb-10">
									<button type="submit" id="kt_sign_in_submit" class="btn btn-primary" onclick="onClick()">
	 ...
	 $(function() {
      ...
      $(".preloader").fadeOut();
		...
		?>
			$.notify({
				title:"",
				message: '<i class="fa fa-times-circle"></i> Login error, Capcha Error',
				},{
							// settings
				element: 'body',
				position: null,
