				...
				<div class="card-body">
					...
					<form id="dataForm"  method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
							...
							<div class="col-md-12 ">	
									...
									<div class="form-group row">
										<div class="col-lg-5 col-md-5">
											...
											<div class="col-lg-12 col-md-12 form-group">
												<label>Username *</label>
												 <input type="text" name="username" class="form-control form-control-sm" value="<?php echo $username; ?>" aria-label="taxt rate" required /> 
										...
										<div class="col-lg-7 col-md-7">
											...
											<div class="col-lg-12 col-md-12 form-group">
												<label>Email *</label>
												 <input type="email" name="email" class="form-control form-control-sm" value="<?php echo $email; ?>" aria-label="taxt rate" required /> 
							...
							<div class="card-footer">
								...
								<button type="button" class="btn btn-create pull-right" onClick="save()">
	...
	$.ajax({
	  ...
	  success: function(response) { 
		...
		if(obj.message == 'success'){
			window.location.href = "<?php echo base_url('users_data');?>"
		}else{
			window.location.href = "<?php echo base_url('users_data');?>"
		}
...
clearButton.addEventListener("click", function (event) {
	...
	foto_upload_cover.on("sending",function(a,b,c){
		...
		c.append("csrf_ortyd_vms_name","<?php echo $this->security->get_csrf_hash(); ?>"); //Menmpersiapkan token untuk masing masing foto
	});
		...
		bootbox.confirm({
			...
			callback: function (result) {
				...
				if(result == true){
					...
					$.post('<?php echo base_url($headurl.'/getcover'); ?>',{id : <?php echo $iddata; ?>, csrf_ortyd_vms_name : "<?php echo $this->security->get_csrf_hash(); ?>"}, function (data) {
						if(data != 'null'){
