...
define('base_url_file', $config['base_url']);
...
$config['sess_cookie_name'] = 'ortyd_session_star_pins_prod';
...
$config['csrf_token_name'] = 'csrf_ortyd_vms_name';
$config['csrf_cookie_name'] = 'csrf_cookie_ortyd_vms';
...
$csrf_off = array(
    "/api/auth/getLogin",
	"/api/auth/getLoginJSON",
	"/api/auth/getPemohon",
	"/api/transaction/getPemohon",
    "/api/transaction/getPemohonJSON",
);
