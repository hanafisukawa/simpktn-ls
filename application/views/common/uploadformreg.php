		...
		init: function() {
			...
			this.on("success", function(file, response) {
				...
				if(obj.message == 'success'){
					$(id +' .dropzone-items .dropzone-item:last-child .dropzone-file .dropzone-filename').append('<input type="text" style="display:none" class="form-control form-control-sm" name="evidence['+tableid+']" value="' + obj.id +'" />');
						...
						for (var key in data) {
							...
							var html = '<div class="dropzone-item" id="eviden_data_'+data[key].evidence_id+'">'+
												...
												'<div class="dropzone-file">'+
													...
													'</a>'+
													'<input type="text" style="display:none" class="form-control form-control-sm" name="evidence['+tableid+']" value="' + data[key].id +'" />' +
