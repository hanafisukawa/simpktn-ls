<!--begin::Navbar-->
							<div class="card mb-6 mb-xl-9">
								<div class="card-body pt-9 pb-0" style="    padding-top: 10px !important;">
									<!--begin::Details-->
									<div class="d-flex flex-wrap flex-sm-nowrap mb-6" style="    margin-bottom: 0 !important;">
										<!--begin::Image-->
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-1">
														...
														<span class="badge me-auto" id="header_perusahaan_status">-</span>
													</div>
													<!--end::Status-->
													<!--begin::Description-->
												...
												<div class="d-flex">
														...
														<a style="margin-right:10px;display:none" href="<?php echo base_url().$headurl; ?>" class="btn btn-sm  btn-danger "> 
															<i class="fa fa-undo"></i> Kembali
														</a>
														
														<button <?php if($status_data_id != 2){echo ' style="display:none"' ;}else{echo ' style="margin-right:10px"' ;} ?> id="kt_docs_formvalidation_text_draft" type="button" class="btn btn-sm  btn-secondary pull-right">
															<i class="fa fa-save"></i> Simpan
														</button>
														
														<?php if($status_data_id == 2){ 
															$btn_submit = 'Simpan dan Kirim';
															}elseif($status_data_id == 3 || $status_data_id == 5 || $status_data_id == 6){ 
																$btn_submit = 'Verifikasi Data';
															}else{
																$btn_submit = 'Simpan dan Kirim';
															}
														?>
...
function getHeaderPerusahaan(id){
	$.post('<?php echo base_url('data_perusahaan_register/getheaderperusahaan'); ?>',{ 
		id : id, 
		...
		if(obj.message == "success"){
			...
			$("#header_perusahaan_status").css('background-color',datanya.status_color);
